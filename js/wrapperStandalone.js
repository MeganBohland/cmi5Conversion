(function(window, document, $, undefined){
    ...
    var link_508 = "../common/508Script.pdf";
    ...
    function onLoadFunctions(e){
        ...
        if(window.location.hostname === "nemesis.jten.mil"){
    ...
    function getProgress(){
        ...
        //for standalone
        currentPage = parseInt(parent.getLastSubTopic(), 10);
    ...
    function changePage(url, pageTitle, pageNum){
        ...
        if(currentPage <= sessionPageProgress){
            ...
            //For standalone
            //Save a new bookmark
            parent.saveLessonProgress(url, currentPage);
        }
